...
<body>
  ...
  <header>
    <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light">
      <div class="container-fluid">
        ...
        <form action="<?= $BASE_URL ?>search.php" method="GET" id="search-form" class="d-flex">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.3/js/bootstrap.bundle.min.js" integrity="sha512-w5rRhxVvkIPt4GHXJmivjyvFv5G7p9gZAT/lnGdHwVJoF0Jrn6Jv+pABUmVdwdjk7KDwX+qGKFbX7r6/yUe3bg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
</body>
